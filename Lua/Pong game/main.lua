...
function love.update(dt)
    ...
    if gameState == 'play' then
        if ball.dx < 0 and ball.x < VIRTUAL_WIDTH / 1.3 then
            if player1.y + 8 < ball.y then
                player1.dy = PADDLE_SPEED

            elseif player1.y + 8 > ball.y then
                player1.dy = -PADDLE_SPEED
            end
        else
            player1.dy = 0
    ...
    -- player 2 movement
    if gameState == 'play' then
        if ball.dx > 0 and ball.x > VIRTUAL_WIDTH/ 4.3 then 
            if player2.y + 8 < ball.y then
                player2.dy = PADDLE_SPEED

            elseif player2.y + 8 > ball.y then
                player2.dy = -PADDLE_SPEED
            end
        else
            player2.dy = 0
